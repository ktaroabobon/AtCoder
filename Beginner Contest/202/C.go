...
// page URL: https://atcoder.jp/contests/abc202/tasks/abc202_c
...
func main() {
	...
	for i := 0; i < N; i++ {
		x = BS[i]
		ai1, aok1 := designatedLowerBound(AS, x)
		ai2, aok2 := designatedUpperBound(AS, x)
		ci1, cok1 := designatedLowerBound(CS, i+1)
		ci2, cok2 := designatedUpperBound(CS, i+1)

		if aok1 && aok2 && cok1 && cok2 {
			cnt += (ai2 - ai1 + 1) * (ci2 - ci1 + 1)
		}
	}
